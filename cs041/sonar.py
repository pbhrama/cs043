...
while True:
    # Game setup
    sonarDevices = int(input("How many sonar devices would you like to use? "))
    theBoard = getNewBoard()
    allChests = int(input("How many chests would you like to find? "))
    theChests = getRandomChests(allChests)
    drawBoard(theBoard)
    previousMoves = []
