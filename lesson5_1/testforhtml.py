...
def application(environ, start_response):
    ...
    if path == '/register' and un and pw:
        ...
        return ['<form action="/login" style="background-color:gold"> <h1>Login</h1><input type="submit" value="Log in"></form>'.encode()]
    elif path == '/register':
        return ['<form action="/register" style="background-color:gold"> <h1>Register</h1> <input type="submit" value="Register"> </form>'.encode()]
